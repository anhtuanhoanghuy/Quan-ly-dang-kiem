    ...
    <body>
        <div class="web">
            ...
            <div class="introNavigation_direction hideThis">
                ...
                <a href="/Dang-kiem-main/RegistrationManagement" id="registrationManager" class="introDirection">Quản lý đăng kiểm</a>
                <a id="Menu" onclick="dropDownMenu()">
                        <span class="material-symbols-outlined" id="Menu_icon">
                            menu
                        </span>
                </a>
                <a href="/Dang-kiem-main/AccountManagement/changeAccountInformation" id="Account" class="introDirection account" onclick = "getData()">Quản lý tài khoản</a>
                <ul class="menuList_content" id="menuList">
                    ...
                    <li><a href="/Dang-kiem-main/RegistrationManagement" id="menuRegistrationManager" class="introDirection">Quản lý đăng kiểm</a></li>
                    <li><a href="/Dang-kiem-main/AccountManagement/changeAccountInformation" id="Account" onclick = "getData()" >Quản lý tài khoản</a></li>
                </ul>
